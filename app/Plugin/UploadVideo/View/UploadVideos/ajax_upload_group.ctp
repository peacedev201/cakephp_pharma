                ...
                <ul class="list6 ">
                    ...
                    <li>
                        ...
                        <div class="col-md-10">
                            ...
                            <a href="javascript:void(0);" class="btn btn-action" id="triggerUpload"><?php echo __('Upload Queued Files') ?></a>
                            <a href="javascript:void(0);" class="btn btn-action" id="saveBtn" style="display: none"><?php echo __('Save Video'); ?></a>
                        </div>
                        <div class="clear"></div>
                    </li>
                </ul>
