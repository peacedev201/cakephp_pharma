                ...
                <form id="createForm" >
                    <ul class="list6">
                        ...
                        <li>
                            ...
                            <div class="col-md-10">
                                <?php echo $this->Form->select('category_id', $categories, array('value' => '')); ?>
                            </div>
                            <div class="clear"></div>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <div class="col-md-10">
                                <?php echo $this->Form->text('tags', array('value' => '')); ?> <a href="javascript:void(0)" class="tip profile-tip" title="<?php echo __('Separated by commas or space') ?>">(?)</a>
                            </div>
                            <div class="clear"></div>
                        </li>
                        <li>
                            ...
                            <div class="col-md-10">
                                <?php echo $this->Form->select('privacy', array(PRIVACY_EVERYONE => __('Everyone'), PRIVACY_FRIENDS => __('Friends Only'), PRIVACY_ME => __('Only Me')), array('value' => '', 'empty' => false)); ?>
                            </div>
                            <div class="clear"></div>
                        </li>
                        <li>
                            ...
                            <div class="col-md-10">
                                ...
                                <a href="javascript:void(0);" class="btn btn-action video-upload" id="triggerUpload"><?php echo __('Upload Queued Files'); ?></a>
                                <a href="javascript:void(0);" class="btn btn-action video-upload" id="saveBtn" style="display: none"><?php echo __('Save Video'); ?></a>
                            </div>
                            <div class="clear"></div>
                        </li>
                    </ul>
