...
<div class="portlet-body">
    <div class="table-toolbar">
        <div class="row">
            <div class="col-md-6">
                <div class="btn-group">
                    <button class="btn btn-gray" data-toggle="modal" data-target="#ajax" href="<?php echo  $this->request->base ?>/admin/business/business_locations/create_state/<?php echo $country['BusinessLocation']['id'] ?>">
                        <?php echo __d('business', 'Add New State/City/Province');?>
                    </button>
        ...
        <tbody>
            ...
            foreach ($states as $location): ?>
                <tr class="gradeX <?php ( ++$count % 2 ? "odd" : "even") ?>" id="<?php echo  $location['BusinessLocation']['id'] ?>">
                    ...
                    <td width="50px" class="reorder"><?php echo  ($location['BusinessLocation']['enabled']) ? 'Yes' : 'No' ?></td>
