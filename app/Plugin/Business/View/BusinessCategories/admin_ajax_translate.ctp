...
<div class="modal-body">
    <form id="tCreateForm" class="form-horizontal" role="form">
        <?php echo $this->Form->hidden('id', array('value' => $category['BusinessCategory']['id'])); ?>
...
<?php endif; ?>
    jQuery(document).ready(function() {
       jQuery.admin.initTranslate("<?php echo  $this->request->base ?>/admin/business/business_categories/ajax_translate_save"); 
    });
<?php if($this->request->is('ajax')): ?>
</script>
<?php else: ?>
