<?php
    ...
    echo __d("business", "shared %s's %s", "<a href=".$parent_activity['User']['moo_href'].">".$parent_activity['User']['name']."</a>", "<a href=".$this->request->base."/users/view/".$parent_activity['User']['id']."/activity_id:".$parent_activity['Activity']['id'].">".__d('business', 'post')."</a>");
?>
