<?php if ($is_enable): ?>
    ...
    <div class="box2 usernote-widget" >
        ...
        <textarea style="display: none" class="usernote-text-hidden no-grow">
            <?php echo $this->Moo->cleanHtml($this->Text->convert_clickable_links_for_hashtags( $note_content));?>
        </textarea>
        ...
        <div class="usernotes" >
            <div class="row">
                    <div class="col-md-12">
                        <textarea readonly="true" class="form-control usernote-content no-grow" rows="10"   style="background-color:white;cursor: default; max-height: 250px;overflow-y: auto"><?php echo h($this->Moo->cleanHtml($this->Text->convert_clickable_links_for_hashtags( $note_content))); ?></textarea>
                    </div>
            </div>
            ...
            <div class="row usernote-action" style="padding:5px;display: none">
                <div class="col-md-6 text-right col-xs-6">
                    <a   class="btn btn-action usernote-save"><?php echo __d('usernotes','Save'); ?></a>
                </div>
                <div class="col-md-6 col-xs-6">
                    <a  class="button button-action text-left usernote-cancel"><?php echo __d('usernotes','Cancel'); ?></a>
                </div>
            </div>
