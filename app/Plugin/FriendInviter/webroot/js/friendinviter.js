...
(function (root, factory) {
    ...
    var initOnGetcontacts = function (provide_id,totalContacts,total_allow_select) {
       ...
       $('#skip_action').click(function () {
            var url = mooConfig.url.base + '/friend_inviters';
            ...
            if (checked) {
                ...
                mooAjax.post({
                    ...
                    data: postData
                       ...
                       if ( json.result == 1 ){
                           window.location.href = mooConfig.url.base + '/friend_inviters/invited';                        
                        } else {
    ...
    var initOnIndex = function () {
        ...
        var uploader = new mooFileUploader.fineUploader({
            ...
            autoUpload: true,
            text: {
                uploadButton: '<div class="upload-section"><i class="fa fa-file-text-o"></i>' + mooPhrase.__('drag_or_click_here_to_upload_file') + '</div>'
            },
            validation: {
