...
<?php else:?>
    <a class="feedback_shortcut" data-toggle="modal" data-target="#themeModal" data-backdrop="static" href="<?php echo $this->request->base;?>/feedback/feedbacks/ajax_create">
        FEEDBACK
    </a>
<?php endif;?>
<style>
    <?php if(Configure::read('Feedback.feedback_position') == 1):?>
        .menustore-wrapper {
            top: 20%;
        }
    <?php endif;?>
