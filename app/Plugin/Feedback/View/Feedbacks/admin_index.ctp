            ...
            <table class="table table-striped table-bordered" id="sample_1">
                ...
                <?php foreach ($aFeedbacks as $key => $aFeedback):?>
                    <tr>
                        ...
                        <td><a href="<?php echo $this->request->base.'/feedback/feedbacks'?>/view/<?php echo $aFeedback['Feedback']['id']?>/<?php echo seoUrl(htmlspecialchars($aFeedback['Feedback']['title']))?>"><?php echo  htmlspecialchars($aFeedback['Feedback']['title']) ?></a></td>
