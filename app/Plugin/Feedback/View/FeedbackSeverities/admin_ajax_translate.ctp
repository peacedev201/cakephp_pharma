...
<div class="modal-body">
    <form id="tCreateForm" class="form-horizontal" role="form">
        <?php echo $this->Form->hidden('id', array('value' => $severity['FeedbackSeverity']['id'])); ?>
        <?php foreach ($languages as $key => $language) : ?>
            ...
            <div class="form-body">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <?php foreach ($severity['nameTranslation'] as $translation) : ?>
...
<div class="modal-footer">
    ...
    <a href="#" id="tCreateButton" onclick='Translate("<?php echo  $this->request->base; ?>/admin/feedback/feedback_severities/ajax_translate_save")' class="btn btn-action">Save Change</a>
</div>