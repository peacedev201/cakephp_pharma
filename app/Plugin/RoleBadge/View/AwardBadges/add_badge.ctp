...
<div class="modal-footer">
    <?php if(!empty($aAwardBadges)): ?>
    <a href="javascript:void(0);" id="btnSave" class="btn btn-action"><?php echo __d('role_badge', 'Done'); ?></a>
    <?php endif; ?>
    
    <a href="javascript:void(0);" class="button button-action" data-dismiss="modal"><?php echo __d('role_badge', 'Close'); ?></a>
</div>
