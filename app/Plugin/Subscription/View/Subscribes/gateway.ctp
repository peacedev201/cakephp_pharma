...
<div class="bar-content  full_content p_m_10">
    <div class="content_center gateway_content">
        ...
        <?php echo $this->Session->flash('subscription');?>      
			<div>
        		<?php echo __('Your selected plan');?>: <b><?php echo $plan['SubscriptionPackage']['name'].' - '. $helperSubscription->getPlanDescription($plan['SubscriptionPackagePlan'],$currency['Currency']['currency_code']) ?></b> <a href="<?php echo $this->request->base?>/subscription/subscribes?cancel=1"><?php echo __('Change to other Packages');?></a>
        	</div>
        	<?php
