...
<div class="row comment-item" id="comment_<?php echo $comment['QuestionComment']['id']?>">
    <div class="col-md-2 comment-avatar">
		...
		<p class="cmt-author">
            <a class="moocore_tooltip_link" data-item_id="<?php echo $comment['User']['id']?>" data-item_type="user" href="<?php echo $comment['User']['moo_href']?>" title="<?php echo $comment['User']['moo_title']?>">
        ...
        <div class="cm-content-wrap">
			...
			<div id="comment_edit_<?php echo $comment['QuestionComment']['id']?>" class="comments-form_content" style="display:none;">
				...
				<div class="commentButton">
					<a href="javascript:void(0)" data-id="<?php echo $comment['QuestionComment']['id']?>" class="question_cancel_edit_comment btn btn-action"><?php echo __('Cancel');?></a>															
					<a href="javascript:void(0)" data-id="<?php echo $comment['QuestionComment']['id']?>" class="question_save_edit_comment btn btn-action"><?php echo __('Edit');?></a>
				</div>
			</div>
