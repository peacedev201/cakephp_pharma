			...
			<div class="poll-info">
				<a href="<?php echo $poll['Poll']['moo_href']; ?>" class="title">
					...
					<?php if ($poll['Poll']['feature']):?>
						<img class="poll_feature" alt="" src="<?php echo $this->Html->assetUrl('Poll.img/star.png');?>">
					<?php endif;?>
				</a>				
					...
					<div class="like-section">
						<div class="like-action">
							<a href="<?php echo $poll['Poll']['moo_href']; ?>/#comments">
								<i class="material-icons">comment</i>&nbsp;<span id="comment_count"><?php echo $poll['Poll']['comment_count']?></span>
							</a>
							<a href="<?php echo $poll['Poll']['moo_href']; ?>" class="<?php if ($like && $like['Like']['thumb_up']): ?>active<?php endif; ?>">
								<i class="material-icons">thumb_up</i>
							</a>
							<a href="<?php echo $this->request->base?>/likes/ajax_show/Poll_Poll/<?php echo $poll['Poll']['id']?>" data-target="#pollModal" data-toggle="modal" class="" title="<?php echo __d('poll','People Who Liked This')?>">
							...
							<?php if(empty($hide_dislike)): ?>
								...
								<a href="<?php echo $this->request->base?>/likes/ajax_show/Poll_Poll/<?php echo $poll['Poll']['id']?>/1" data-target="#pollModal" data-toggle="modal" class="" title="<?php echo __d('poll','People Who Disliked This')?>">
									<span id="dislike_count"><?php echo $poll['Poll']['dislike_count']?></span>
								</a>
							<?php endif;?>
							<a href="<?php echo $poll['Poll']['moo_href']; ?>">
								<i class="material-icons">share</i>&nbsp;<span><?php echo $poll['Poll']['share_count']?></span>
							</a>
						</div>
					</div>
				</div>
