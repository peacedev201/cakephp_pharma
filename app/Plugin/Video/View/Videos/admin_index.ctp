...
<div id="center">
	...
	<table class="mooTable footable" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td><a href="<?php echo $this->request->base?>/videos/create/<?php echo $video['Video']['id']?>" class="overlay" title="<?php echo h($video['Video']['title'])?>"><?php echo h($video['Video']['title'])?></a></td>
