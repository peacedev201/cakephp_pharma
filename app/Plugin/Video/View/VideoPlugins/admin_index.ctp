        ...
        <table class="table table-striped table-bordered table-hover" id="sample_1">
            ...
            foreach ($videos as $video): ?>
                <tr class="gradeX <?php (++$count % 2 ? "odd" : "even") ?>">
                    ...
                    <td><a href="<?php echo  $this->request->base ?>/videos/create/<?php echo  $video['Video']['id'] ?>" target="_blank"><?php echo $this->Text->truncate(h($video['Video']['title']), 100, array('eclipse' => '...')) ?></a></td>
