            ...
            <div class="forum-reply-action">
                ...
                ?>
                    ...
                    $this->MooPopup->tag(array(
                        ...
                        'innerHtml'=>'<i class="material-icons">flag</i>'.__d('forum', 'Report'),
                        'class' => 'forum-btn-link'
                    ));
                    ?>
                ...
                <?php if ( ($reply['ForumTopic']['user_id'] == $uid ) || ( !empty( $reply['ForumTopic']['id'] ) && !empty($cuser) && $cuser['Role']['is_admin'] ) || $is_moderator ): ?>
                    ...
                    <a id="" href="<?php echo $this->request->base.'/forums/topic/reply/'.$reply['ForumTopic']['id'];?>?page=<?php echo $page;?>" class="forum-btn-link">
