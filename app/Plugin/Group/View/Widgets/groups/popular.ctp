                ...
                <?php foreach ($popular_groups as $group): ?>
                    <li>
                        <a href="<?php echo $this->request->base?>/groups/view/<?php echo $group['Group']['id']?>/<?php echo seoUrl($group['Group']['name'])?>">
                            <img width="70" alt="<?php echo h($group['Group']['name'])?>" src="<?php echo $groupHelper->getImage($group, array('prefix' => '75_square'))?>" class="group-thumb" >
                        </a>
                        <div class="group_detail">
                            <div class="title-list">
                                <a href="<?php echo $this->request->base?>/groups/view/<?php echo $group['Group']['id']?>/<?php echo seoUrl($group['Group']['name'])?>"><?php echo h($group['Group']['name']) ?></a>
