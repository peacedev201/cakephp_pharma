    ...
    <div class="content_center">
        ...
        <div class="mo_breadcrumb bookmark-button">
            ...
            <?php if(!empty($my_status) && $my_status['GroupUser']['status'] == GROUP_USER_ADMIN): ?>
                <a href="<?php echo  $this->request->base ?>/groups/level_up/<?php echo  $group['Group']['id'] ?>" class="button button-action topButton button-mobi-top" style="background-color: #ffd966;color: black;"><?php echo __('Level up')?></a>  
            <?php endif; ?>     
