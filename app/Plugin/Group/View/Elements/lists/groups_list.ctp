            ...
            <div class="group-info">
                ...
                <div class="extra_info">
                    ...
                    switch ($group['Group']['type']) {
                        case PRIVACY_PUBLIC:
                            echo '<span style="color:#247BBA;font-weight:bold;">'.$community.'</span>'.', '.__( 'Public');
                            break;

                        case PRIVACY_RESTRICTED:
                            echo '<span style="color:#247BBA;font-weight:bold;">'.$community.'</span>'.', '.__( 'Restricted');
                            break;

                        case PRIVACY_PRIVATE:
                            echo '<span style="color:#247BBA;font-weight:bold;">'.$community.'</span>'.', '.__( 'Private');
                            break;
                    }
                    ?> .
