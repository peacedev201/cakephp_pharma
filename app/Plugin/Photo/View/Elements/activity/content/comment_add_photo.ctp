...
<div class="photo-comment-feed">
    ...
    <div class="photo_item_comment">
        <a class="photoModal" href="<?php echo $object['Photo']['moo_href']?>#content"><img src="<?php echo $photoHelper->getImage($object, array('prefix' => '850'));?>" class="wall_photo_comment"></a>
    </div>
</div>