...
$this->Html->addCrumb(__('Album Categories'), array('controller' => 'album_categories', 'action' => 'admin_index'));
$this->startIfEmpty('sidebar-menu');
echo $this->element('admin/adminnav', array('cmenu' => 'Photo'));
$this->end();
?>
<?php echo  $this->Moo->renderMenu('Photo', __('Categories')); ?>
...
<div class="portlet-body">
    <div class="table-toolbar">
        <div class="row">
            <div class="col-md-6">
                <div class="btn-group">
                    <button class="btn btn-gray" data-toggle="modal" data-target="#ajax" href="<?php echo  $this->request->base ?>/admin/photo/album_categories/create">
                        <?php echo __('Add New');?>
                    </button>
