 ...
 */
class ContestCategoriesController extends ContestAppController {
    ...
    public function admin_index() {
        ...
        $this->set('type', $type);
        $this->set('title_for_layout', __d('contest', 'Categories Manager'));
    }
    ...
    public function admin_create() {
        ...
        $headers = $this->Category->find('list', array('conditions' => array('Category.type' => 'Contest', 'Category.header' => 1), 'fields' => 'Category.name'));
        $headers[0] = '';
    ...
    public function admin_save() {
        ...
        // clear cache
        Cache::delete('categories', 'contest');
        $this->Session->setFlash(__d('contest', 'Category has been successfully saved'), 'default', array('class' => 'Metronic-alerts alert alert-success fade in'));
        $response['result'] = 1;
