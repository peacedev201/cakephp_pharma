                        ...
                        <li class="col-md-3 full_content select_entry_li">
                            <div class="albums_edit_item">
                                <a href="javascript:void(0)" data-id="<?php echo $video['Video']['id']  ?>" data-fname="<?php echo $video['Video']['thumb'];  ?>" data-file="<?php echo $videoHelper->getImage($video, array('prefix' => '450'))?>" class="entry_select">
                                    ...
                                    <input id="video_<?php echo $video['Video']['id']  ?>" style="float:right;margin-bottom:5px;" data-id="<?php echo $video['Video']['id']  ?>" data-fname="<?php echo $video['Video']['thumb'];  ?>" data-file="<?php echo $videoHelper->getImage($video, array('prefix' => '450'))?>" type="submit" value="<?php echo __d('contest', 'Add to contest') ?>" class="btn btn-action photo_submit_btn">
                                </a>
                            </div>
                        </li>
                    <?php endforeach; ?>
