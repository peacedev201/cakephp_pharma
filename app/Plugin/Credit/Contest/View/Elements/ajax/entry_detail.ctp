...
<div class="entry_detail_voted">
    ...
    <div class="entry_detail_image">
        <?php ?>
        <div class="entry_image_large <?php if($entry['ContestEntry']['source'] != 'photo' && $entry['ContestEntry']['source'] != 'music'): ?>video-detail<?php endif; ?>">
    ...
    <div class="entry_pager_links_holder">
        <div class="entry_pager_links">
            ...
            <a class="pager_previous_link" href="<?php echo $prev_entry['ContestEntry']['moo_href']; ?>" title="<?php echo __d('contest', 'Previous Entry') ?>"><i class="material-icons">navigate_before</i> <?php echo __d('contest', 'Previous Entry'); ?></a>
                <?php else: ?>
            ...
            <a class="pager_previous_link" href="<?php echo $next_entry['ContestEntry']['moo_href']; ?>" title="<?php echo __d('contest', 'Next Entry') ?>"><?php echo __d('contest', 'Next Entry'); ?> <i class="material-icons">navigate_next</i></a>
                <?php else: ?>
