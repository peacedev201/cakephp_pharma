...
<div class="box2 buy_credit">
    ...
    <div class="box_content ">
       ...
       <div class="btt_buy_credit">
            <a class="btn btn-action" href="<?php echo $this->request->base?>/credits/ajax_sell" data-target="#themeModal" data-toggle="modal" class="" title="<?php echo __d('credit', 'Buy Credits')?>"><?php echo __d('credit', 'Buy Credits')?>! </a>
       </div>
	</div>
</div>
<?php endif;?>
