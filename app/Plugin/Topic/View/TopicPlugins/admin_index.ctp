                ...
                foreach ($topics as $topic):
                    ...
                    <tr class="gradeX <?php ( ++$count % 2 ? "odd" : "even") ?>">
                     ...
                     <?php endif; ?>
                        ...
                        <td><a href="<?php echo  $this->request->base ?>/topics/create/<?php echo  $topic['Topic']['id'] ?>" target="_blank"><?php echo $this->Text->truncate(h($topic['Topic']['title']), 100, array('eclipse' => '...')) ?></a></td>
                        ...
                        <td><?php echo h($topic['Group']['name'])?></td>
