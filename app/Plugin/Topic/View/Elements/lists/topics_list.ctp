...
<?php if(empty($hide_like)): ?>
                                    <a data-type="Topic_Topic" data-id="<?php echo $topic['Topic']['id']?>" data-status="1" href="javascript:void(0)" class="likeItem <?php if (!empty($uid) && !empty($topic['Like'][0]['thumb_up'])): ?>active<?php endif; ?>">
...
<?php endif; ?>
                                    ...
                                    <a data-type="Topic_Topic" data-id="<?php echo $topic['Topic']['id']?>" data-status="0" href="javascript:void(0)" class="likeItem <?php if (!empty($uid) && isset($topic['Like'][0]['thumb_up']) && $topic['Like'][0]['thumb_up'] == false): ?>active<?php endif; ?>">
