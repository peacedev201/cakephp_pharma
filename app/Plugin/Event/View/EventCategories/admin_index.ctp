...
$this->Html->addCrumb(__('Event Categories'), array('controller' => 'event_categories', 'action' => 'admin_index'));
$this->startIfEmpty('sidebar-menu');
echo $this->element('admin/adminnav', array('cmenu' => 'Event'));
$this->end();
?>
<?php echo $this->Moo->renderMenu('Event', __('Categories'));?>
...
<div class="portlet-body">
    <div class="table-toolbar">
        <div class="row">
            <div class="col-md-6">
                <div class="btn-group">
                    <button class="btn btn-gray" data-toggle="modal" data-target="#ajax" href="<?php echo $this->request->base?>/admin/event/event_categories/create/">
                        <?php echo __('Add New');?>
                    </button>
