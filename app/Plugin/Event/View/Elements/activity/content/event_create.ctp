...
<div class="activity_item">
	...
	<a class="event_feed_image <?php if($event['Event']['photo'] == ''): ?> event_no_image<?php endif; ?>" href="<?php echo $event['Event']['moo_href']?>" >
            ...
            <div class="event-date"><?php echo $this->Time->event_format($event['Event']['from'], '%b %d, %Y')?></div>
        </a>
    </div>
	...
	<div class="event_feed_info">
            ...
            <div class="event_feed_extrainfo event_time">
                <span><?php echo __('Time')?>:</span><?php echo $this->Time->event_format($event['Event']['from'], '%B %d, %Y')?> <?php echo $event['Event']['from_time']?> - 
