...
<?php if ($uid): ?>
    <a <?php if ($choice['choice'] == 1) echo 'id="btn-choice"' ?> class="btn btn-action submit_answer_yes" data-id="<?php echo $faq['Faq']['id'] ?>" href="javascript:void(0)"><?php echo __d('faq', 'Yes') ?></a>
    <a <?php if ($choice['choice'] == 0) echo 'id="btn-choice"' ?> href="javascript:void(0)" data-id="<?php echo $faq['Faq']['id'] ?>" class="btn btn-action js_drop_down_helpful"><?php echo __d('faq', 'No') ?></a>
<?php else: ?>
...
<?php endif; ?>
    ...
    <form id="answernoForm<?php echo $faq['Faq']['id'] ?>" method="POST">
        ...
        <a href="javascript:void(0)" data-id="<?php echo $faq['Faq']['id'] ?>" class="btn btn-action answerno-faq-list"><?php echo __d('faq', 'Submit') ?></a>
