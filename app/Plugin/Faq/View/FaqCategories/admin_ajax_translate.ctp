<script>
    $(document).ready(function() {
        $('#tCreateButton').click(function() {
            ...
            $.post("<?php echo  $this->request->base ?>/admin/faq/faq_categories/ajax_translate_save", $("#tCreateForm").serialize(), function(data) {
...
<div class="modal-header">
    ...
    <h4 class="modal-title"><?php echo  __d('faq',"Translation") ?></h4>
</div>
...
<div class="modal-footer">
    ...
    <a href="#" id="tCreateButton" class="btn btn-action"><?php echo __d('faq','Save Changes') ?></a>
</div>