...
<div class="share-content">
    ...
    <div class="video-feed-info video_feed_content">
        ...
        <div class="video-description comment_message feed_detail_text">
            <?php echo $this->Text->truncate(nl2br($this->Text->convert_clickable_links_for_hashtags($video['description'], Configure::read('Video.video_hashtag_enabled') )), 400, array('exact' => false, 'html' => true))?>
        </div>
    </div>
