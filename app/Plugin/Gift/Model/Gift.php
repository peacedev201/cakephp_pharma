...
class Gift extends GiftAppModel 
{
    ...
    public function getAttribute($plugin){
        $response = [];
        ...
        switch ($plugin) {
            case 'ad plugin':
                ...
                break;
            case 'bookmark plugin':
                $response = [
                    'field' =>  'BOOKMARK',
                    'valid' =>  'BOOKMARK_valid'
                ];
                break;
            case 'check-in plugin':
                $response = [
                    'field' =>  'CHECKIN',
                    'valid' =>  'CHECKIN_valid'
                ];
            ...
            case 'quiz plugin':
                ...
                break;
            case 'reaction like facebook plugin':
                $response = [
                    'field' =>  'REACTION',
                    'valid' =>  'REACTION_valid'
                ];
                break;
            case 'user notes plugin':
                $response = [
                    'field' =>  'USERNOTE',
                    'valid' =>  'USERNOTE_valid'
                ];
                break;
            case 'video conference plugin':
                $response = [
                    'field' =>  'VIDEO',
                    'valid' =>  'VIDEO_valid'
                ];
