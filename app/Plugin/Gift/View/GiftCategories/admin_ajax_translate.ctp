<script>
    $(document).ready(function() {
        ...
        $('#tCreateButton').click(function() {
            ...
            $.post("<?php echo  $this->request->base ?>/admin/gift/gift_categories/ajax_translate_save", $("#tCreateForm").serialize(), function(data) {
...
<div class="modal-body">
    <form id="tCreateForm" class="form-horizontal" role="form">
        <?php echo $this->Form->hidden('id', array('value' => $category['GiftCategory']['id'])); ?>
