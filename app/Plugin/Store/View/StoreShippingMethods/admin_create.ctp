<?php
    ...
    $this->Html->addCrumb(__d('store',  "Edit Store Shipping Method"));
...
<div id="page-wrapper">
    <div class="panel panel-default">
        <div class="panel-heading">
            <?php echo __d('store', "Edit Store Shipping");?>
            <div class="pull-right">
                <input id="btnSave" type="button" class="btn btn-primary btn-xs" value="<?php echo __d('store', 'Save');?>" onclick="saveStoreShippingMethod()"/>
                <input id="btnApply" type="button" class="btn btn-primary btn-xs" value="<?php echo __d('store', 'Apply');?>" onclick="saveStoreShippingMethod(1)"/>
        ...
        <div class="panel-body">
            ...
            <form class="form-horizontal" id='createForm' method="post">
                ...
                <?php echo $this->Form->hidden('id', array(
                    'value' => $store_shipping_method['id']
                ));?>
                <div id="lang-tabs">
                    <ul>
...
function saveStoreShippingMethod(apply)
{
