    ...
    <div class="content_center">
        ...
        <div class="panel panel-default">
                ...
                <div class="pull-right">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right" role="menu">
                            <li>
                                <a title="<?php echo __d('store', "Add New");?>" href="<?php echo STORE_MANAGER_URL?>shipping_zones/create">
            ...
            <div class="panel-body">
                <form id="searchForm" method="get" action="<?php echo STORE_MANAGER_URL.'shipping_zones/index';?>">
                ...
                <?php if(!empty($shipping_zones)):?>
                    <form class="form-horizontal" id="adminForm" method="post" action="<?php echo STORE_MANAGER_URL.'shipping_zones/';?>">
                        <div class="div-detail-app manage-shipping_zone">
                            ...
                            <div class="div-detail-row ">
                                <div class="top-list-brb">
                                    <?php echo __d('store', "Shipping Zone Listing");?>
                                </div>
                                    ...
                                    <div class="group-group">
                                        ...
                                        <i class="text-app">
                                            <?php echo $this->Form->checkbox('cid.', array(
                                                'hiddenField' => false,
                                                'id' => 'cb'.$shipping_zone['id'],
                                                'class' => 'multi_cb',
                                                'value' => $shipping_zone['id']
                                            ));?>
                                        </i>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-8 col-custom-4">
                                    <div class="group-group group-group-name text-left">
                                        ...
                                        <i class="text-app"><?php echo $shipping_zone['name'];?></i>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-1">
                                    <div class="group-group">
                                        <i class="visible-sm visible-xs icon-app material-icons">done_all</i>
                                            <?php if($shipping_zone['enable']):?>
                                        <a href="javascript:void(0)" class="action_disable" data-id="<?php echo $shipping_zone['id']?>">
                                            <i class="text-app material-icons" title="<?php echo __d('store', "Disable");?>">done</i>
                                        </a>
                                            <?php else:?> 
                                        <a href="javascript:void(0)" class="action_enable" data-id="<?php echo $shipping_zone['id']?>">
                                ...
                                <div class="hidden-xs hidden-sm col-md-2 padding-0 no-border-right">
                                    <a class="action-manage" href="<?php echo $url;?>create/<?php echo $shipping_zone['id'];?>">
                                        <i class="text-full"> <?php echo __d('store', 'Edit');?></i>
                                    </a>

                                    <a class="action-manage action_delete" href="javascript:void(0)" data-id="<?php echo $shipping_zone['id']?>">
                                        <i class="text-full "><?php echo __d('store', 'Delete') ?></i>                                
                                    </a>
                                </div>
                                <div class="visible-sm visible-xs col-xs-6 iconnottext isleft">
                                    <a href="<?php echo $url;?>create/<?php echo $shipping_zone['id'];?>">
                                        <i class="material-icons">create</i>
                                    </a>
                                </div>
                                <div class="visible-sm visible-xs col-xs-6 iconnottext">
                                    <a class="action_delete" href="javascript:void(0)" data-id="<?php echo $shipping_zone['id']?>">
                ...
                <?php else:?>
                    <?php echo __d('store', "No Shipping Zones");?>
                <?php endif;?>
            </div>
