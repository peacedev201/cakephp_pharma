...
<?php if(empty($hide_like)): ?>
                                    <a data-type="Blog_Blog" data-id="<?php echo $blog['Blog']['id']?>" data-status="1" href="javascript:void(0)" class="likeItem <?php if (!empty($uid) && !empty($like['Like']['thumb_up'])): ?>active<?php endif; ?>">
...
<?php endif; ?>
                                    ...
                                    <a data-type="Blog_Blog" data-id="<?php echo $blog['Blog']['id']?>" data-status="0" href="javascript:void(0)" class="likeItem <?php if (!empty($uid) && isset($like['Like']['thumb_up']) && $like['Like']['thumb_up'] == 0): ?>active<?php endif; ?>">
