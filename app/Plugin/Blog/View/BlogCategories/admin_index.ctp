...
$this->Html->addCrumb(__('Blog Categories'), array('controller' => 'blog_categories', 'action' => 'admin_index'));
$this->startIfEmpty('sidebar-menu');
echo $this->element('admin/adminnav', array('cmenu' => 'Blog'));
$this->end();
?>
<?php echo  $this->Moo->renderMenu('Blog', __('Categories')); ?>
...
<div class="portlet-body">
    <div class="table-toolbar">
        <div class="row">
            <div class="col-md-6">
                <div class="btn-group">
                    <button class="btn btn-gray" data-toggle="modal" data-target="#ajax" href="<?php echo  $this->request->base ?>/admin/blog/blog_categories/create">
                        <?php echo __('Add New');?>
                    </button>
 ...
 ?>
                    ...
                    <td width="50px" class="reorder"><?php echo  ($category['Category']['header']) ? __('Yes') : __('No') ?></td>
                    <td width="50px" class="reorder"><?php echo  ($category['Category']['active']) ? __('Yes') : __('No') ?></td>
