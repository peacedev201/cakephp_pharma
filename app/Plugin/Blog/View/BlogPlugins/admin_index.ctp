        ...
        <table class="table table-striped table-bordered table-hover" id="sample_1">
            ...
            foreach ($blogs as $blog): ?>
                <tr class="gradeX <?php (++$count % 2 ? "odd" : "even") ?>">
                    ...
                    <td><a href="<?php echo $this->request->base?>/blog/blogs/create/<?php echo $blog['Blog']['id']?>" target="_blank"><?php echo $this->Text->truncate(h($blog['Blog']['title']), 100, array('eclipse' => '...')) ?></a></td>
