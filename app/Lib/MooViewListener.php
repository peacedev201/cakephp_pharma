...
// Initialing the mooSocial phrases for javascript functions
    public function initPhraseJs()
    {
        ...
        return $this->getView()->addPhraseJs(array(
            ...
            'you_has_been_verified_with_sms' => __('You has been verified with sms'),
            'an_email_has_been_sent_to_your_new_email' => __('An email has been sent to your new email address. Please click the validation link to confirm your email.'),
            ...
            'not_define_sale_area' => __('You have not defined your sale area. Please update your sale area in Profile, first. Please click %s to move your Profile update', '<a href="/users/profile_3">'.__('this').'</a>')
        ));
    }
