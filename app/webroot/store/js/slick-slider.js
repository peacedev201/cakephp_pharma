    ...
    b = function() {
        function c(c, d) {
            ...
            if (e.defaults = {
                    ...
                    arrows: !0,
                    asNavFor: null,
                    prevArrow: '<button type="button" data-role="none" class="slick-prev"><i class="material-icons">chevron_left</i></button>',
                    nextArrow: '<button type="button" data-role="none" class="slick-next"><i class="material-icons">chevron_right</i></button>',
                    autoplay: !1,
                    autoplaySpeed: 3e3,
                    centerMode: !1,
                    centerPadding: "50px",
