    ...
    i.parseTarget = function(t) {
        ...
        return {
            ...
            options: function(i, s) {
                ...
                if ("string" == typeof i) {
                    if ("undefined" == typeof s) return "undefined" == typeof this._options[i] ? null : this._options[i];
                    this._options[i] = s
        ...
        return r.fn = r.prototype = t.extend({}, i.base(s), e), t.fn[s] = function(i) {
            ...
            return this.each("string" == typeof i ? function() {
                ...
                var o = r[i].apply(r, e);
                return o !== r && "undefined" != typeof o ? (n = o, !1) : void 0
            } : function() {
                var e = t(this).data(s);
    ...
    t.jCarousel.plugin("jcarousel", {
        ...
        closest: function() {
            ...
            return this.rtl && this.relative && !this.vertical && (r += this.list().width() - this.clipping()), this.items().each(function() {
                ...
                var a = e.dimension(n);
                if (r += a, r >= 0) {
                    if (i = a - s(n.css("margin-" + l)), !(Math.abs(r) - a + i / 2 <= 0)) return !1;
                    o = !0
                }
            }), n
        },
        ...
        hasNext: function() {
            ...
            return i >= 0 && !this.underflow && (t && "first" !== t || this.index(s) < i || this.tail && !this.inTail) ? !0 : !1
        },
        hasPrev: function() {
            ...
            if (r.relative) {
                ...
                if (r.target > 0) {
                    ...
                    if (g >= d && this.tail) this.inTail ? "both" === p || "last" === p ? this._scroll(0, s, e) : t.isFunction(e) && e.call(this, !1) : this._scrollTail(s, e);
                        ...
                        for (f = d, h = this.items().get(-1); f++ < l;) h = this.items().eq(0), u = this._visible.index(h) >= 0, u && h.after(h.clone(!0).attr("data-jcarousel-clone", !0)), this.list().append(h), u || (c = {}, c[this.lt] = this.dimension(h), this.moveBy(c)), this._items = null;
                        this._scroll(h, s, e)
        ...
        _scroll: function(i, s, e) {
            ...
            if ("object" != typeof i ? i = this.items().eq(i) : "undefined" == typeof i.jquery && (i = t(i)), 0 === i.length) return t.isFunction(e) && e.call(this, !1), this;
        ...
        _animate: function(i, s, e) {
            ...
            var r = this.options("animation"),
                ...
                l = o.complete || t.noop;
            return s === !1 ? o.duration = 0 : "undefined" != typeof t.fx.speeds[o.duration] && (o.duration = t.fx.speeds[o.duration]), o.complete = function() {
                n(), l.call(this)
            }, this.move(i, o), this
        },
        _prepare: function(i) {
            ...
            if (!this.circular && !f && u > h)
                for (a = l; !(--a < 0) && (e = this.items().eq(a), 0 !== e.length) && (o = this.dimension(e), 0 !== o) && (h += o, d.first = e, d.visible = d.visible.add(e), n = s(e.css("margin-" + c)), u >= h - n && (d.fullyvisible = d.fullyvisible.add(e)), !(h >= u)););
...
function(t) {
    ...
    t.jcarousel.fn.scrollIntoView = function(i, s, e) {
        ...
        if (r = n.relative ? n.target < 0 ? Math.max(0, o + n.target) : l + n.target : "object" != typeof n.target ? n.target : this.index(n.target), o > r) return this.scroll(r, s, e);
    ...
    t.jCarousel.plugin("jcarouselPagination", {
        ...
        _reload: function() {
            ...
            if (this._pages = {}, this._items = {}, t.isFunction(i) && (i = i.call(this)), null == i) this._pages = this._calculatePages();
                ...
                for (var s, e = parseInt(i, 10) || 0, r = this._getCarouselItems(), n = 1, o = 0; s = r.eq(o++), 0 !== s.length;) this._pages[n] = this._pages[n] ? this._pages[n].add(s) : s, o % e === 0 && n++;
            this._clear();
            var l = this,
        ...
        _calculatePages: function() {
            for (var t, i, s = this.carousel().data("jcarousel"), e = this._getCarouselItems(), r = s.clipping(), n = 0, o = 0, l = 1, a = {}; t = e.eq(o++), 0 !== t.length;) i = s.dimension(t), n + i > r && (l++, n = 0), n += i, a[l] = a[l] ? a[l].add(t) : t;
            return a
        },
...
function(t, i) {
    ...
    t.each(r, function(t, r) {
        return "undefined" != typeof i[t] ? (s = t, e = r, !1) : void 0
