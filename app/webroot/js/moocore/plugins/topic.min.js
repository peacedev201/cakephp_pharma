...
b)})};return{initOnCreate:function(){a("#saveBtn").unbind("click");a("#saveBtn").click(function(){a(this).addClass("disabled");null!==f.activeEditor&&a("#editor").val(f.activeEditor.getContent());d.createItem("topics",!0)});var b=new k.fineUploader({element:a("#attachments_upload")[0],autoUpload:!1,text:{uploadButton:'<div class="upload-section"><i class="material-icons">photo_camera</i>'+h.__("drag_or_click_here_to_upload_photo")+" </div>"},validation:{allowedExtensions:mooConfig.attachmentExt,sizeLimit:mooConfig.sizeLimit},
request:{endpoint:mooConfig.url.base+"/topic/topic_upload/attachments/"+a("#plugin_topic_id").val()},callbacks:{onError:l.errorHandler,onComplete:function(b,e,c){b=a("#attachments").val();c.attachment_id?(f.activeEditor.insertContent('<p><a href="'+mooConfig.url.base+"/attachments/download/"+c.attachment_id+'" class="attached-file">'+c.original_filename+"</a></p><br>"),""==b?a("#attachments").val(c.attachment_id):a("#attachments").val(b+","+c.attachment_id)):c.thumb&&(a("#topic_photo_ids").val(a("#topic_photo_ids").val()+
","+c.photo_id),f.activeEditor.insertContent('<p align="center"><a href="'+c.large+'" class="attached-image"><img src="'+c.thumb+'"></a></p><br>'))}}});a("#triggerUpload").click(function(){b.uploadStoredFiles()});new k.fineUploader({element:a("#topic_thumnail")[0],multiple:!1,text:{uploadButton:'<div class="upload-section"><i class="material-icons">photo_camera</i>'+h.__("drag_or_click_here_to_upload_photo")+"</div>"},validation:{allowedExtensions:mooConfig.photoExt,sizeLimit:mooConfig.sizeLimit},
request:{endpoint:mooConfig.url.base+"/topic/topic_upload/avatar"},callbacks:{onError:l.errorHandler,onComplete:function(b,e,c){a("#topic_thumnail_preview > img").attr("src",c.thumb);a("#topic_thumnail_preview > img").show();a("#thumbnail").val(c.file_path)}}});a(".attach_remove").unbind("click");a(".attach_remove").click(function(){var b=a(this),e=a(this).data();p.post({url:mooConfig.url.base+"/attachments/ajax_remove/"+e.id},function(c){b.parent().fadeOut();c=a("#attachments").val().split(",");
