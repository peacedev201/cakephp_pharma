...
a("#saveBtn").unbind("click");a("#saveBtn").click(function(){a(this).addClass("disabled");null!==tinyMCE.activeEditor&&a("#editor").val(tinyMCE.activeEditor.getContent());g.createItem("events",!0)});f()},initOnView:function(){f();n()},initOnListing:function(){g.initMoreResults();f()},initOnInvitePopup:function(){m()}}});