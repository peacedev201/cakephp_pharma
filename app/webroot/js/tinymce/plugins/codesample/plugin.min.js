    ...
    r("tinymce/codesampleplugin/Prism", [], function() {
        var e = {},
            ...
            n = function() {
                                            ...
                                            if (!(g instanceof i)) {
                                                ...
                                                if (v) {
                                                    ...
                                                    var y = v.index - 1 + p,
                                                        ...
                                                        N = [h, 1];
                                                    C && N.push(C);
                                                    var _ = new i(s, d ? n.tokenize(v, d) : v, m);
                                                    N.push(_), w && N.push(w), Array.prototype.splice.apply(o, N)
                                                }
                                            }
                                        }
                                    }
                ...
                return r.stringify = function(e, t, i) {
                ...
                }, t.document ? void 0 : t.addEventListener ? (t.addEventListener("message", function(e) {
        ...
        function r(e, t, r) {
            e.undoManager.transact(function() {
                var o = i(e);
                r = s.encode(r), o ? (e.dom.setAttrib(o, "class", "language-" + t), o.innerHTML = r, n.highlightElement(o), e.selection.select(o)) : (e.insertContent('<pre id="__new" class="language-' + t + '">' + r + "</pre>"), e.selection.select(e.$("#__new").removeAttr("id")[0]))
            })
        }
        ...
        return {
            open: function(e) {
                e.windowManager.open({
                    ...
                    minWidth: Math.min(s.getViewPort().w, 800),
                    minHeight: Math.min(s.getViewPort().h, 650),
                    layout: "fit",
                    body: [{
                        type: "listbox",
                        name: "language",
                    ...
                    onSubmit: function(t) {
                        r(e, t.data.language, t.data.code)
                    }
                })
            }
        }
        ...
        t.add("codesample", function(t, s) {
            function l() {
                var e;
                o || (o = !0, e = t.dom.create("link", {
                    rel: "stylesheet",
                    href: s + "/css/prism.css"
                }), t.getDoc().getElementsByTagName("head")[0].appendChild(e))
            }
            var c = t.$;
            e.ceFalse && (t.on("PreProcess", function(e) {
                c("pre[contenteditable=false]", e.node).filter(a(i.isCodeSample)).each(function(e, t) {
                    var n = c(t),
                        r = t.textContent;
                    n.attr("class", c.trim(n.attr("class"))), n.removeAttr("contentEditable"), n.empty().append(c("<code></code>").each(function() {
                        this.textContent = r
                    }))
                })
            }), t.on("SetContent", function() {
                var e = c("pre").filter(a(i.isCodeSample)).filter(function(e, t) {
                    return "false" !== t.contentEditable
                });
                e.length && t.undoManager.transact(function() {
                    e.each(function(e, r) {
                        c(r).find("br").each(function(e, n) {
                            n.parentNode.replaceChild(t.getDoc().createTextNode("\n"), n)
                        }), r.contentEditable = !1, r.innerHTML = t.dom.encode(r.textContent), n.highlightElement(r), r.className = c.trim(r.className)
                    })
                })
