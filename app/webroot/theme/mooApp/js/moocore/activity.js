...
(function (root, factory) {
    ...
    var postWall = function()
    {
        ...
        var msg = $('#message').val();
        if ($.trim(msg) != '' || ($("#video_destination").length > 0 && $("#video_destination").val() !== '') || ($('#wall_photo_preview :not(#addMoreImage)').html() != '' && $('#wall_photo_preview :not(#addMoreImage)').html() != 'add'))
        {
