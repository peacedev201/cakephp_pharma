...
//Custom
define('SPECIALTY_PHARMACIST', 1);
define('SPECIALTY_STUDENT', 2);
define('SPECIALTY_OTHER', 3);

define('AVATAR_PUBLIC', 1);
define('AVATAR_FRIEND', 2);
define('AVATAR_MEMBER', 3);
define('AVATAR_DISABLE', 4);

define('PHARMACIST_GENERAL', 1);
define('PHARMACIST_SALE', 2);
define('PHARMACIST_OTHER', 3);
define('OTHER_GENERAL', 4);
define('OTHER_SALE', 5);
define('OTHER_OTHER', 6);
define('GROUP_STUDENT', 7);
define('FEELING_EXTEND_FOREVER', '99');
define('VIDEO_EXTEND_FOREVER', '99');
define('STICKER_EXTEND_FOREVER', '99');