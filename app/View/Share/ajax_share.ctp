            ...
            <div class="userTagged" style="display:block">
                ...
                <div class="stt-action share-action">
                    ...
                    <div class="user-tagging-container">
                        <i class="" data-toggle="tooltip" title="<?php echo __('Tag people in your post'); ?>" onclick="$('.userTagging-userTaggingOnShareForm').toggleClass('hidden')"><em class="material-icons">person_add</em></i>
                    </div>
