    ...
    <div class="tooltip_main">
        ...
        <div class="item_geneal_info">
            <div class="item_title">
                <?php echo h($this->Text->truncate(isset($object[$type]['name'])?$object[$type]['name']:$object[$type]['title'], 30, array('exact' => false)))?>
            ...
            <?php if($type == 'User'): ?>
                ...
                <?php if (Configure::read("core.enable_show_birthday_profile_popup") && !empty( $object['User']['birthday'] ) && $object['User']['birthday'] != '0000-00-00'): ?>
                    <div class="item_stat extra_info"><span class="date"><?php echo __('Born on')?>:</span> <?php echo $this->Time->event_format($object['User']['birthday'], '%B %d')?></div>
                <?php endif; ?>
            <?php endif; ?> 
            <?php if($type == 'User'): ?>
              <div class="item_stat">                  
    ...
    <?php if($type == 'User' && $object['User']['id'] != $uid && !empty($uid)): ?>   
              <div class="item_tooltip_actions">                                         
                  ...
                  <?php if (Configure::read("core.enable_follow")): ?>
                      ...
                      <?php endif; ?>
                  <?php endif; ?>
                  <?php $this->getEventManager()->dispatch(new CakeEvent('View.Activities.ajaxLoadTooltip.afterRenderButton', $this)); ?>
            </div>                                               
          <?php endif; ?>
