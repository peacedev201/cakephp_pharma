			...
			<div class="poll_user_right">
				...
				<ul>
					...
					<?php if ($item['PollItem']['total_user'] > $count_user):?>
						<li class="more_user">
							<a href="<?php echo $this->request->base?>/polls/ajax_show_user_answer/<?php echo $item['PollItem']['id']?>" data-target="#pollModal" data-toggle="modal" data-dismiss="modal" data-backdrop="true">+<?php echo ($item['PollItem']['total_user'] - $count_user) ?></a>
						</li>
					<?php endif;?>
				</ul>
			...
			<div class="poll_user_left">
				...
				<div class="poll_result">
					<div class="a" title="<?php echo $item['PollItem']['name'];?>">
						...
						<div class="poll_vote"><span><?php echo $item['PollItem']['total_user'];?> <?php echo __d('poll','votes');?></span></div>
					</div>
				</div>
			</div>
			...
			<div class="poll_user_left">
				...
				<div class="poll_result">
					<div class="a">
						...
						<a class="click_target" href="<?php echo $poll['Poll']['moo_href']?>"></a>					
					</div>
				</div>
			</div>
		</div>
		...
		<div class="add_more poll_item">
			<div class="poll_user_right">
				<?php if ($helper->isMobile()):?>
					<button class="mdl-button--raised mdl-button--colored1 poll_button_add_more" data-poll-id="<?php echo $poll['Poll']['id']?>"><?php echo __d('poll','Add');?></button>
				<?php endif;?>
			</div>
			<div class="poll_user_left">
