...
<div class="bar-content">
    <div class="content_center">
        ...
        <div class="clear"></div>
        <div id="app-form-verification" class="full_content p_m_10 form-verification">
            <div class="form_content">
                <form id='uploadPhotoForm' action="<?php echo  $this->request->base; ?>/profile/verify/save?app_no_tab=1" method="post">
                    ...
                    <a href="javascript:void(0);" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored action-verification" id="triggerUpload"><?php echo __( 'Upload Queued Files')?></a>
                    <a href="javascript:void(0);" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored action-verification" id="nextStep" style="display: none"><?php echo __d('verify_profile', 'Submit Documents'); ?></a>
                </form>
            </div>
        </div>
    </div>
...
<div class="verify-profile-header" style="margin-top: 15px;">
    <div class="box_content">
