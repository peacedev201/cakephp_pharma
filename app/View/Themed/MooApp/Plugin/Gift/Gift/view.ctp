...
<div class="bar-content">
    <div class="content_center">
        ...
        <div class="gift-body">
            ...
            <video  class="video-js vjs-default-skin" controls preload="auto" width="100%" height="350" controlsList="nodownload">
			...
			<div id="audioplayer">
                ...
                <audio id="music" controls autoplay controlsList="nodownload">
