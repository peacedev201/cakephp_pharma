...
<li>
    <ul id="my-gift-type">
        <li <?php if(empty($param) || $param == GIFT_SAVED):?>class="active"<?php endif;?>>
            <a id="" href="<?php echo $this->request->base;?>/gifts/index/my/saved?app_no_tab=1">
                <?php echo __d('gift', 'Saved gifts');?>      
            </a>
        </li>
        <li <?php if($param == GIFT_RECEIVED):?>class="active"<?php endif;?>>
            <a id="" href="<?php echo $this->request->base;?>/gifts/index/my/received?app_no_tab=1">
                <?php echo __d('gift', 'Received gifts');?>
            </a>
        </li>
        <li <?php if($param == GIFT_SENT):?>class="active"<?php endif;?>>
            <a id="" href="<?php echo $this->request->base;?>/gifts/index/my/sent?app_no_tab=1">
            ...
            <?php elseif($param == GIFT_RECEIVED):?>
                <li class="full_content p_m_10" id="mygift<?php echo $giftSent['id'];?>">
                    ...
                    <div class="blog-info">
                        ...
                        <?php endif;?>
                        <a class="button button-action" href="<?php echo $this->request->base;?>/conversations/ajax_send/<?php echo $sender['id'];?>">
            ...
            <?php elseif($param == GIFT_SENT):?>
                <li class="full_content p_m_10" id="mygift<?php echo $giftSent['id'];?>">
                    ...
                    <div class="blog-info">
                        ...
                        <?php endif;?>
                        <a class="button button-action" href="<?php echo $this->request->base;?>/conversations/ajax_send/<?php echo $receiver['id'];?>">
                            <?php echo __d('gift', 'Send message');?>
                        </a>
                        <!--<a href="javascript:void(0)" class="view_gift button button-action" data-id="<?php echo $giftSent['id'];?>">
                            <?php echo __d('gift', 'View');?>
