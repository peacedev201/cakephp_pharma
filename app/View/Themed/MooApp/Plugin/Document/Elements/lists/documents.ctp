		...
		<li class="full_content p_m_10 document_list">
			...
			<div class="document-info">
				...
				<div class="extra_info">
					...
					?>
					<a style="color:#888;"  class="tip" href="javascript:void(0);" original-title="<?php echo  $tooltip ?>"> <?php echo $icon?></a>
				</div>
			...
			<div class="like-section">
				<div class="like-action">
					<a href="<?php echo $document['Document']['moo_href']; ?>/#comments">
						<i class="material-icons md-24">comment</i><span id="comment_count"><?php echo $document['Document']['comment_count']?></span>
					</a>
					...
					<?php endif;?>
					<a href="<?php echo $document['Document']['moo_href']; ?>">
						<i class="material-icons md-24">file_download</i>&nbsp;<span><?php echo $document['Document']['download_count']?></span>
					</a>
					<a href="<?php echo $document['Document']['moo_href']; ?>">
						<i class="material-icons md-24">visibility</i>&nbsp;<span><?php echo $document['Document']['view_count']?></span>
					</a>
					<a href="<?php echo $document['Document']['moo_href']; ?>">
						<i class="material-icons md-24">reply</i>&nbsp;<span><?php echo $document['Document']['share_count']?></span>
					</a>
				</div>
			</div>
		</li>	
