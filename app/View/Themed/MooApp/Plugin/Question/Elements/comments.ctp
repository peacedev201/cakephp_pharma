	...
	<div <?php if ($comment_count > count($comments)):?>style="display:none;"<?php endif;?> class="comments-form">
		...
		<?php if ($canComment == QUESTION_CAN_ERROR_NONE):?>
			<div class="comments-form_content" style="display:none;">
				<a href="<?php echo $viewer['User']['moo_href']?>">						
				...
				<div class="comments-right">
					...
					<div class="commentButtonApp">															
						<a href="javascript:void(0)" data-id="<?php echo $id;?>" data-type="<?php echo $type;?>" class="mdl-button--raised mdl-button--colored1 question_comment_action"><?php echo __('Comment');?></a>
					</div>
				</div>
			</div>
		<?php endif;?>
