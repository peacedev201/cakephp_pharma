            ...
            <div class="list_option">
                <div class="dropdown">
                    ...
                    <ul role="menu" class="dropdown-menu loadQuizView" aria-labelledby="dropdown-sort">
                        <li class="no-current">
                            <a href="javascript:void(0)" data-url="<?php echo $this->request->base . '/quizzes/view_participant/' . $quiz['Quiz']['id'] . '/latest'; ?>" rel="quiz-content"><?php echo __d('quiz', 'Latest'); ?></a>
                        </li>
                        <li class="no-current">
                            <a href="javascript:void(0)" data-url="<?php echo $this->request->base . '/quizzes/view_participant/' . $quiz['Quiz']['id'] . '/score'; ?>" rel="quiz-content"><?php echo __d('quiz', 'Score'); ?></a>
                        </li>
                    </ul>
                </div>
            </div>
