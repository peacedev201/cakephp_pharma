        ...
        <div class="review-info">
            ...
            <div class="dropdown list_option">
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li>
                        <a href="javascript:void(0);" class="loadModalContent" data-url="<?php echo $this->request->base . '/reviews/write/' . $aUserReview['Review']['user_id'] . '/' . $aUserReview['ReviewUser']['id'] . '/' . $type; ?>"><?php echo __d('review', 'Edit Review'); ?></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="javascript:void(0);" class="loadModalContent" data-url="<?php echo $this->request->base . '/reviews/reply/' . $aUserReview['ReviewUser']['id']; ?>"><?php echo __d('review', 'Reply Review'); ?></a>
                    </li>
                    <?php endif; ?>
                    
                    <li>
                        <a href="<?php echo $this->Html->url(array("controller" => "reports", "action" => "ajax_create", "plugin" => false, "Review.ReviewUser", $aUserReview['ReviewUser']['id'])); ?>"><?php echo __d('review', 'Report Review'); ?></a>
                    </li>
                </ul>
            </div>
            <?php endif; ?>
            ...
            <div class="review-detail-content">
                ...
                <div class="content content-reply">
                    ...
                    <div class="dropdown list_option list-option-reply">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li>
                                <a href="javascript:void(0);" class="loadModalContent" data-url="<?php echo $this->request->base . '/reviews/reply/' . $aUserReview['ReviewUser']['id']; ?>"><?php echo __d('review', 'Edit Reply'); ?></a>
                            </li>
                            <li>
...
<?php else: ?>
<?php $this->Html->scriptStart(array('inline' => false, 'requires' => array('mooReview'), 'object' => array('mooReview'))); ?>
mooReview.initBrowseReview();<?php $this->Html->scriptEnd(); ?>
<?php endif; ?>