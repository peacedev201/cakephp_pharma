    ...
    <div class="create_form">
        <form id="reviewForm">
            <ul class="list6 full_content">
                ...
                <li>
                    <div class="col-sm-12">
                        <div id="images-uploader">
                            ...
                            <input type="button" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored" id="triggerUpload" value="<?php echo __d('review', 'Upload Queued Files'); ?>">
                        </div>
                ...
                <li>
                    <div class="col-sm-12">
                        <a href="javascript:void(0);" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored" id="reviewBtn"><?php echo (!empty($aReviewUser['ReviewUser']['id'])) ? __d('review', 'Save') : __d('review', 'Post'); ?></a>
                        <a href="javascript:void(0);" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored1" data-dismiss="modal"><?php echo __d('review', 'Cancel'); ?></a>
                    </div>
                    <div class="clear"></div>
                </li>
            </ul>
