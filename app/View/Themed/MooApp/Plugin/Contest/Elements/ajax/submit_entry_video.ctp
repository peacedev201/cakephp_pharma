    ...
    <div class="bar-content full_content p_m_10">
        <div class="content_center">
            <div class="create_form">
                ...
                <?php else: ?>
                    <form id="createForm" data-action="<?php echo $this->request->base ?>/contests/entry_upload_onapp">
                        ...
                        <?php echo __d('contest', 'Copy and paste the video url in the text field below'); ?><br /><br />
                            <ul class="list6 list6sm2">
                                ...
                                <li>
                                    ...
                                    <div class="col-md-10">
                                        <a href="#" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored" id="fetchButton"><?php echo __d('contest', 'Fetch Video')?></a>
                                    </div>
                    ...
                    <div style="margin-top: 8px;">
                        <p><?php echo __d('contest', 'Or') ?> <a href="<?php echo $this->request->base ?>/contests/select_videos/<?php echo $contest['Contest']['id']; ?>?app_no_tab=1" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored"><?php echo __d('contest', 'Select your videos'); ?></a></p>
                    </div>
                    <?php endif; ?>
                <?php endif; ?>
            <?php else: ?>
