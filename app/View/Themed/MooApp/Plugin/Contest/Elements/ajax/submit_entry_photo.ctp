    ...
    <div class="bar-content full_content p_m_10">
        <div class="content_center">
            <?php if ($helper->integrate_credit() && $contest['Contest']['submit_entry_fee'] > 0): ?>
                ...
                <?php else: ?>
                    <form id="uploadEntryForm" data-action="<?php echo $this->request->base ?>/contests/entry_upload_onapp">
                    ...
                    <?php if ($photo_count > 0): ?>
                        <div style="margin-top: 8px;">
                            <p><?php echo __d('contest', 'Or') ?> <a href="<?php echo $this->request->base ?>/contests/select_photos/<?php echo $contest['Contest']['id']; ?>?app_no_tab=1" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored"><?php echo __d('contest', 'Select your photos'); ?></a></p>
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
            <?php else: ?>
