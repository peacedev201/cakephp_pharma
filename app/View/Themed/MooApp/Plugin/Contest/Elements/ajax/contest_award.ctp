        ...
        <div class="form_content">
            <ul>	
                ...
                <li style="margin-top: 8px;">
                    <div class="col-md-10">
                        <button type="button" id="updateBtn" class='mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored btn-action'><?php echo __d('contest' ,'Save')?></button>
...
<div id="contest_award">
    ...
    <?php if($helper->canEdit($contest, $viewer)): ?>
        <a id="edit_award" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored1" href="javascript:void(0)">
