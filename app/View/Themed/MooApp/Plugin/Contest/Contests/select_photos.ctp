                        ...
                        <li class="col-md-3 full_content select_entry_li">
                            <div class="albums_edit_item">
                                ...
                                <a href="javascript:void(0)" data-id="<?php echo $photo['Photo']['id']  ?>" data-fname="<?php echo $photo['Photo']['thumbnail'];  ?>" data-file="<?php echo $url; ?>" class="entry_select">
                                    ...
                                    <input id="photo_<?php echo $photo['Photo']['id']  ?>" style="float:right;margin-bottom:5px;" type="submit" value="<?php echo __d('contest', 'Add to contest') ?>" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored1 photo_submit_btn">
                                </a>
                            </div>
                        </li>
                    <?php endforeach; ?>
