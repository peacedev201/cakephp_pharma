        ...
        <div class="col-sm-6">
            <div class="forum-lists-index">
                ...
                <div class="forum-lists-info">
                    ...
                    <div class="forum-count-info">
                        <span class="forum-text-count"><?php echo number_format($forum['Forum']['count_topic']);?> <?php echo $forum['Forum']['count_topic'] == 1 ? __d('forum','topic') : __d('forum','topics');?></span> | <span class="forum-text-count"><?php echo number_format($forum['Forum']['count_reply']);?> <?php echo $forum['Forum']['count_reply'] == 1 ? __d('forum','reply') : __d('forum','replies');?></span>
                    </div>
            ...
            <div class="forum-user-lastest">
                <?php if(!empty($forum['last_topic'])): ?>
                    ...
                    <div class="forum-lastest-main">
                        ...
                        <span class="forum-latest-info"><?php echo __d('forum', 'By: ').$this->Moo->getName($forum['last_topic']['User'], true); ?></span>
                    </div>
                <?php else:?>
