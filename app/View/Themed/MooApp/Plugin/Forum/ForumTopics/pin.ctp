    ...
    <div class="">
        <form id="pinTopicForm" method="post" action="<?php echo !$is_moderator ? $this->request->base .'/forum/forum_pins/gateway' : $this->request->base .'/forum/forum_pins/moderator';?>">
            ...
            <div class="pin-form-action">
                <button class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored1" id="btn_pin"><?php echo __d('forum','Pin now');?></button>
                <a href="<?php echo $topic['ForumTopic']['moo_href'].'?app_no_tab=1';?>" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised"><?php echo __d('forum','Cancel');?></a>
                <div class="clear"></div>
            </div>
