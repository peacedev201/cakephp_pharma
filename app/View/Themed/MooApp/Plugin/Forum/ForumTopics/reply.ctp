                    ...
                    <form action="<?php echo  $this->request->base; ?>/forums/topic/save_reply" enctype="multipart/form-data" id="topicReplyForm<?php echo $id;?>" method="post">
                        ...
                        <ul class="list6">
                            ...
                            <li>
                                ...
                                <div class="col-md-10">
                                    <a id="topic_reply_button" class='mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored1 topic_reply_button' data-id="<?php echo $id;?>"><?php echo __d('forum' ,'Post')?></a>
                                    <a href="<?php echo $this->request->base.'/forums/topic/view/'.$reply['ForumTopic']['parent_id'];?>" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised"><?php echo __d('forum' ,'Cancel')?></a>
                                </div>
                                <div class="clear"></div>
                            </li>
                            <li>
