    ...
    <form id="tagMemberForm" name="tagMemberForm" class="form-horizontal" role="form">
        <div class="form-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <a class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised" data-dismiss="modal"><?php echo  __d('forum','Close') ?></a>
                    <a id="insert_into_reply" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored1"><?php echo  __d('forum','Insert into reply') ?></a>
                </div>
