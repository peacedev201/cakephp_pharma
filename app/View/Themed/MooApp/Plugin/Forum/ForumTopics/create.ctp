                        ...
                        <div class="form_content">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="col-md-10">
                                        <a id="button_save_topic" class='mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored1'><?php echo __d('forum' ,'Save')?></a>
                                        <a href="<?php
                                        if(empty($topic['ForumTopic']['id']))
                                        ...
                                        ?>" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised"><?php echo __d('forum','Cancel');?></a>
                                    </div>
                                    <div class="clear"></div>
                                </li>
                                <li>
