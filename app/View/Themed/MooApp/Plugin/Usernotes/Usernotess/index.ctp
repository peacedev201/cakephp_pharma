...
<?php $this->end(); ?>
    ...
    <div class="bar-content">
        <div class="content_center full_content p_m_10">
            ...
            <!-- <div class="mo_breadcrumb usernote-title">
                <h1><?php echo __d('usernotes','My notes')?></h1>
            </div> -->
            
            <ul class="usernotes-content blog-content-list" id="list-content">
                <?php 
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <textarea name="content" class="form-control " id="unote-content" style="overflow: auto !important; background-color:white;cursor: default; max-height: 250px;">&nbsp;</textarea> 
            </div>
            <div class="modal-footer">
                <div class="error-message unoteErrorMessage"  style="display:none;text-align: left;margin-bottom: 2px;"></div>
                <a href="javascript:void(0);" id="unote-btn-save" class="btn btn-clean ok"><?php echo __d('usernotes', 'Save') ?></a>
                <a type="button" class="btn btn-clean" data-dismiss="modal"><?php echo __d('usernotes', 'Cancel') ?></a>
            </div>
        </div>
    </div>
</section>  
