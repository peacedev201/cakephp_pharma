        ...
        <li <?php if (isset($type) && $type == 'home'): ?>id="friend_<?php echo $user['Friend']['friend_id'] ?>"<?php endif; ?>
            ...
            <div class="row" style="height:30px;">
                <div class="col-md-12 text-right">
                    <div class="list_option" style="position: relative;">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel"  >
                                ...
                                <li>  
                                    <!-- <?php echo $this->base.'/usernotess/remove_note/'.$user['User']['id']; ?> -->
                                    <a class="unote_delete_app" data-id="<?php echo $user['User']['id'];?>" data-action="" href="javascript:void(0);"><?php echo __d('usernotes', 'Delete') ?></a>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<style type="text/css" media="screen">
    ...
    .user-list-index .list-content img{
        width: 100%;
    }

    .user-list-index .list-content .user-name-info{
        text-align: center;
    }

    .user-list-index .detail-note{
        margin-left: 90px;
    }
    .usernote-title{
