            ...
            <div class="create_form create_form_feedback">
                ...
                <ul class="list6 list6sm2" style="position:relative">
                    ...
                    <li>
                        ...
                        <div class="col-md-10">
                            <a href="#" id="createButton" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored1"><?php echo __d('feedback', 'Save');?></a>
                            <a class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored1" href="javascript:void(0)" data-dismiss="modal"><?php echo __d('feedback', 'Close');?></a>
                        </div>
                        <div class="clear"></div>
                    </li>
                </ul>
