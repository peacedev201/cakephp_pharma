    ...
    <div>
        <div class="content_center full_content">
                ...
                <div class="feedback-detail-wrapper">                  
                    <h1 style="position: relative"><div class="h1_title"><?php echo htmlspecialchars($aFeedback['Feedback']['title'])?></div>
                    <div class="list_option" style="right:10px; position: absolute;">
                        <div class="dropdown">
                            ...
                            <ul aria-labelledby="dropdown-edit" class="dropdown-menu feedback-dropdown" role="menu">
                                 <?php if($permission_set_status): ?>
                                    <li>
                                        <a href="<?php echo $this->request->base.$url_feedback.$url_ajax_add_status.'/'.$aFeedback['Feedback']['id']?>" data-target="#themeModal" data-toggle="modal">
                                ...
                                <?php if(MooCore::getInstance()->getViewer(true) > 0):?>
                                    ...
                                    <li>
                                        <a href="<?php echo $this->request->base.$url_feedback?>/ajax_create/<?php echo $aFeedback['Feedback']['id']?>?app_no_tab=1">
                                    ...
                                    <?php endif; ?>
                                <?php endif;?>
                                <li><a href="<?php echo $this->request->base?>/reports/ajax_create/feedback_feedback/<?php echo $aFeedback['Feedback']['id']?>" class="" title="<?php echo __d('feedback', 'Report Feedback')?>"><?php echo __d('feedback', 'Report Feedback')?></a></li>
                                <?php echo $this->element('share/menu',array('param' => 'Feedback_Feedback','action' => 'feedback_item_detail' ,'id'=>$aFeedback['Feedback']['id'])); ?>
                            </ul>
                        </div>
                    </div></h1>
                    <span class="date">
