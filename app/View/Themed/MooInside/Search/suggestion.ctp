    <?php if(!empty ($users)): ?>
        <li class="header-filter" style="background-color:#F1F1F1"><span class="col-xs-8"><?php echo  __('PEOPLE'); ?></span><a class="col-xs-4" style="display:block" href="<?php echo  $this->request->base; ?>/search/suggestion/user/<?php echo  $searchVal; ?>"><?php echo  __('View all'); ?> </a></li>
