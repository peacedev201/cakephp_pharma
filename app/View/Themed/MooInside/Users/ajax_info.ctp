    ...
    <div class="content_center">
        <div class="post_body">
            <ul class="profile-about">
                ...
                <?php endif; ?>	
                <li><label><?php echo __('Gender')?>:</label> <?php echo $user['User']['gender']?></li>
                <?php if ( $user['User']['birthday'] != '0000-00-00' ): ?>
                <li><label><?php echo __('Birthday')?>:</label> <?php echo $this->Time->format($user['User']['birthday'], '%B %d', false, $utz)?></li>
                <?php endif; ?>
