                    ...
                    <div class="full_content p_m_10">
                        <div class="form_content new_form">
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="input_container">
                                    <label><?php echo __( 'Tags')?> <a href="javascript:void(0)" class="tip profile-tip" title="<?php echo __( 'Separated by commas or space')?>">(?)</a></label>
                                    <div>
                        ...
                        <?php if (!empty($attachments)): ?>
                                ...
                                <?php foreach ($attachments as $attachment): ?>
                                            <li><i class="material-icons">attach_file</i> <a href="<?php echo $this->request->base?>/attachments/download/<?php echo $attachment['Attachment']['id']?>" target="_blank"><?php echo $attachment['Attachment']['original_filename']?></a>
                                                &nbsp;<a href="#" data-id="<?php echo $attachment['Attachment']['id']?>" class="attach_remove tip" title="<?php echo __( 'Delete')?>"><i class="material-icons icon-small">clear</i></a>             
                                            </li>
                                <?php endforeach; ?>
                                        </ul>
                                    </div>
