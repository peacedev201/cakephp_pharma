...
<!--
		<?php if ( isset($type) && $type == 'home' ): ?>
                    <a href="<?php echo $this->request->base?>/friends/ajax_remove/<?php echo $user['User']['id']?>" id="removeFriend_<?php echo $user['User']['id']?>" data-target="#themeModal" data-toggle="modal" >
