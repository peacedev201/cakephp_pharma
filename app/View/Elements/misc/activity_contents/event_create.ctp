<div class="activity_item">
	...
	<div class="date comment_message">
		<?php echo $this->Time->event_format($activity['Content']['Event']['from'], '%B %d, %Y')?> <?php echo $activity['Content']['Event']['from_time']?> -
		<?php echo $this->Time->event_format($activity['Content']['Event']['to'], '%B %d, %Y')?> <?php echo $activity['Content']['Event']['to_time']?><br />
