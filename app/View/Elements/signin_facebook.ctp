...
<div class="loginPage">
<div id="loginForm">
    <h1 class="text-center"><?php echo __('Congratulate on facebook login success').'<br/>'. __('From next you can login by')?></h1>
    ...
    <div class="center-login-text text-center">
        ...
        <div><?php echo  __('You can direct login by your email and password send to you as followings')?></div><br/>
    </div>
    ...
    <div class="row p_top_15">
        <div class="col-md-12 text-center">
            <?php echo __('If you can not remember password, please refresh with ');?>
