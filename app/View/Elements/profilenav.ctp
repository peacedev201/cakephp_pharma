<div class="box2 menu">
	...
	<ul class="list2">					
		<li <?php if ($cmenu == 'profile') echo 'class="current"'; ?>>
            ...
            <ul class="list2 list-child">
                <li><a href="<?php echo $this->request->base?>/users/profile_1"><i class="material-icons">adjust</i> <?php echo __('Contact Info')?></a></li>
                <li><a href="<?php echo $this->request->base?>/users/profile_2"><i class="material-icons">adjust</i> <?php echo __('User & Specialty information')?></a></li>
                <li><a href="<?php echo $this->request->base?>/users/profile_3"><i class="material-icons">adjust</i> <?php echo __('Job Infomation')?></a></li>
            </ul>
        </li>
