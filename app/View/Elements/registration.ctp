...
<?php
    if ( ( empty($uid)) ):
?>
<div class="bar-content c-content">
        ...
        <div id="signUpForm" class="row <?php if(!$this->Moo->socialIntegrationEnable('facebook') && !$this->Moo->socialIntegrationEnable('google') && !Configure::read('social.social_enable')): ?>no-social<?php endif; ?>">
                    ...
                    <div class="box51">
                        ...
                        <form id="regForm" class="form-horizontal" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <?php echo  __('By clicking "Join Now" you agree to the Pharmatalk ').$this->Html->link(__('User agreement, privacy and cookie policy.'),array('controller' => 'pages','terms-of-service'),array('target'=>'_blank')); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group regSubmit" id="step1Box">
                                ...
                                <div class="col-md-9">
                                    <input type="button" value="<?php echo __('Join now')?>" id="submitFormsignup" class="btn btn-success">
            ...
            <div class="col-md-sl3">
                <div class="form-group reg-text">
                    <?php echo  __('By clicking any of following social login,')?><br>
                    <?php echo  __('you agree to the Pharma Talk')?>
                    </br>
                    <?= $this->Html->link(__('User agreement, privacy and cookie policy.'),array('controller' => 'pages','terms-of-service'),array('target'=>'_blank')); ?>
                </div>
                <div class="register_social_form">
                    ...
                    <div class="fSignInWrapper nSignInWrapper registerBtnWrapper">
                        <a href="javascript:void(0);" style="color:white">
                        <div class="overlay-button">
                            <span class="icon"></span>
                            <span class="buttonText"><?php echo  __('Naver Login') ?></span>
                        </div>
                        </a>
                    </div>
                    <div class="fSignInWrapper kSignInWrapper registerBtnWrapper">
                        <a href="javascript:void(0);" style="color:white">
                        <div class="overlay-button">
                            <span class="icon"></span>
                            <span class="buttonText"><?php echo  __('Kakao Login') ?></span>
                        </div>
                        </a>
                    </div>
                    <?php if ($this->Moo->socialIntegrationEnable('facebook')): ?>
                    <div class="fSignInWrapper registerBtnWrapper">
                        ...
                        <div class="overlay-button">
                            <span class="icon"></span>
                            <span class="buttonText"><?php echo  __('Facebook Login') ?></span>
                        </div>
                        </a>
                    </div>
                    <?php endif; ?>
