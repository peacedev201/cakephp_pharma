<?php if ($activity['Activity']['target_id']): ?>
    ...
    if ($show_subject):
        ?>
        &rsaquo; <?php if($name != 'User'): ?><a href="<?php echo $subject[$name]['moo_href'] ?>"><?php echo h($subject[$name]['moo_title']) ?></a><?php else: ?><?php echo $this->Moo->getName($subject[$name], false) ?><?php endif; ?>
    <?php endif; ?>
<?php endif; ?>
