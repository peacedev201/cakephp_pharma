        ...
        <div class="p_l_7 check-home">
            ...
            <div class="mo_breadcrumb">
                ...
                <ul class="list7 header-list" id="feed-type">
                    ...
                    <li><a href="<?php echo $this->request->base?>/activities/ajax_browse/region" <?php if ( isset($activity_feed) && $activity_feed == 'region' ) echo 'class="current"'; ?>><?php echo __('My Region Only')?></a></li>
                    <li><a href="<?php echo $this->request->base?>/activities/ajax_browse/jobarea" <?php if ( isset($activity_feed) && $activity_feed == 'job_area' ) echo 'class="current"'; ?>><?php echo __('My Job Area Only')?></a></li>
                </ul>
                <?php endif; ?>
            </div>
