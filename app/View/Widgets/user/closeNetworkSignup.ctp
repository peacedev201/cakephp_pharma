                    ...
                    <div class="register_main_form">
                        <div class="box51">
                            ...
                            <form id="regForm" class="form-horizontal" >
                                ...
                                <div class="form-group">
                                    <?php echo  __('By clicking "Join Now" you agree to the Pharmatalk ')?>
                                    </br>
                ...
                <?php if($this->Moo->socialIntegrationEnable('facebook') || $this->Moo->socialIntegrationEnable('google') || Configure::read('social.social_enable')): ?>
                    <div class="col-md-sl3">
                        ...
                        <div class="register_social_form">
                            <div class="form-group reg-text" style="margin: 0;text-align: left;padding: 0 12px;">
                            ...
                            <div class="fSignInWrapper nSignInWrapper">
                                <a href="javascript:void(0);" style="color:white">
                                    <div class="overlay-button">
                                        <span class="icon"></span>
                                        <span class="buttonText"><?php echo  __('Naver') ?></span>
                                    </div>
                                </a>
                            </div>
                            <div class="fSignInWrapper kSignInWrapper">
                                <a href="javascript:void(0);" style="color:white">
                                    <div class="overlay-button">
                                        <span class="icon"></span>
                                        <span class="buttonText"><?php echo  __('Kakao') ?></span>
                                    </div>
                                </a>
                            </div>
