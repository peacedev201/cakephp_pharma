 ...
 */
	public static function load($className) {
		...
		if ($file) {
			//$result = strpos( $file, "/home/social" );
			//if( $result === false ) {
			    return include $file;
			//} else {				
  			//    return include str_replace( "/home/social" , "/home/social3", $file);
			//}
		}
 ...
 */
	protected static function _loadVendor($name, $plugin, $file, $ext) {
		if ($mapped = static::_mapped($name, $plugin)) {
			...
			//$result = strpos( $mapped, "/home/social" );
			//if( $result === false ) {
				return (bool)include_once $mapped;
			//} else {				
  			//    return include str_replace( "/home/social" , "/home/social3", $mapped);
			//}
